...
task main()
  ...
  regentlib.assert(x0.a ==  9693, "test failed")
  regentlib.assert(x1.a ==  9989, "test failed")
  regentlib.assert(x2.a == 10203, "test failed")
  regentlib.assert(x3.a == 10017, "test failed")
end
