...
task main()
  ...
  regentlib.assert(x0.a ==  9669, "test failed")
  regentlib.assert(x1.a == 10410, "test failed")
  regentlib.assert(x2.a ==  9676, "test failed")
  regentlib.assert(x3.a == 10385, "test failed")
end
