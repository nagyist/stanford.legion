  ...
  const char* const names[LAST_SOURCE_REF] = {      \
    ...
    public:
      DistributedCollectable(
          Runtime* rt, DistributedID did, bool register_with_runtime = true,
    ...
    public:
      ...
      static void handle_unregister_collectable(
    ...
    public:
      static void handle_downgrade_request(
          Runtime* runtime, Deserializer& derez, AddressSpaceID source);
      static void handle_downgrade_response(
          Runtime* runtime, Deserializer& derez);
      static void handle_downgrade_success(
          Runtime* runtime, Deserializer& derez);
      static void handle_downgrade_update(
          Runtime* runtime, Deserializer& derez);
      static void handle_downgrade_restart(
          Runtime* runtime, Deserializer& derez, AddressSpaceID source);
      static void handle_global_acquire_request(
          Runtime* runtime, Deserializer& derez);
    ...
    public:
      ValidDistributedCollectable(
          Runtime* rt, DistributedID did, bool register_with_runtime = true,
          CollectiveMapping* mapping = NULL, bool start_in_valid_state = true);
    ...
    public:
      static void handle_valid_acquire_request(
          Runtime* runtime, Deserializer& derez);
