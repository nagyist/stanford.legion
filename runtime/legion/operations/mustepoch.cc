...
#undef DIMFUNC
    ...
    //--------------------------------------------------------------------------
    {
      ...
      {
        ApEvent next_local = Runtime::merge_events(nullptr, local_complete_events);
