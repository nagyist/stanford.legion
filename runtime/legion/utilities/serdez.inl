...
namespace Legion {
  ...
  //--------------------------------------------------------------------------
  inline size_t Serializer::get_index(void) const
  //--------------------------------------------------------------------------
  {
    return index;
  }
  ...
  //--------------------------------------------------------------------------
  inline const void* Serializer::get_buffer(void) const
  //--------------------------------------------------------------------------
  {
    return buffer;
  }
  ...
  //--------------------------------------------------------------------------
  inline size_t Serializer::get_buffer_size(void) const
  //--------------------------------------------------------------------------
  {
    return total_bytes;
  }
  ...
  //--------------------------------------------------------------------------
  inline size_t Serializer::get_used_bytes(void) const
  //--------------------------------------------------------------------------
  {
    return index;
  }
...
#ifdef DEBUG_LEGION
  //--------------------------------------------------------------------------
  inline size_t Deserializer::get_context_bytes(void) const
  //--------------------------------------------------------------------------
  {
