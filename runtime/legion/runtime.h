...
#define DUMMY_CONTEXT 0
    ...
    public:
      ...
      inline size_t get_allocation_size(void) const { return allocation_size; }
    private:
    ...
    public:
      ...
      public:
        PendingInstance(void) : instance(NULL), creator_uid(0) { }
    ...
    public:
      ...
      FutureImpl(
          TaskContext* ctx, Runtime* rt, bool register_future,
          DistributedID did, Provenance* provenance, Operation* op = NULL);
      ...
      FutureImpl(
          ...
          const ContextCoordinate& coordinate, UniqueID op_uid, int op_depth,
          Provenance* provenance, CollectiveMapping* mapping = NULL);
    ...
    public:
      ...
      const void* get_buffer(
          Processor proc, Memory::Kind memory, size_t* extent_in_bytes = NULL,
          bool check_extent = false, bool silence_warnings = false,
          const char* warning_string = NULL);
      const void* get_buffer(
          Memory memory, size_t* extent_in_bytes = NULL,
          bool check_extent = false, bool silence_warnings = false,
          const char* warning_string = NULL);
      void get_memories(
      ...
      bool is_empty(
          ...
          const char* warning_string = NULL, bool internal = false);
    ...
    public:
      ...
      void set_result(
          ApEvent complete, FutureInstance* instance = NULL,
      ...
      static Future unpack_future(
          Runtime* runtime, Deserializer& derez, Operation* op = NULL,
          GenerationID op_gen = 0, UniqueID op_uid = 0, int op_depth = 0);
    public:
    ...
    public:
      ...
      static void handle_future_subscription(
          Deserializer& derez, Runtime* rt, AddressSpaceID source);
      static void handle_future_create_instance_request(
          Deserializer& derez, Runtime* runtime, AddressSpaceID source);
      static void handle_future_create_instance_response(
    ...
    public:
      FutureMapImpl(
          TaskContext* ctx, Operation* op, IndexSpaceNode* domain, Runtime* rt,
          DistributedID did, Provenance* provenance, bool register_now = true,
          CollectiveMapping* mapping = NULL);
      FutureMapImpl(
          TaskContext* ctx, Runtime* rt, IndexSpaceNode* domain,
          DistributedID did, uint64_t blocking_index,
          const std::optional<uint64_t>& context_index, Provenance* provenance,
    ...
    public:
      ...
      static void handle_future_map_future_request(
          Deserializer& derez, Runtime* runtime, AddressSpaceID source);
      static void handle_future_map_future_response(
          Deserializer& derez, Runtime* runtime);
      static void handle_future_map_find_pointwise(
          Deserializer& derez, Runtime* runtime);
    public:
      TaskContext* const context;
    ...
    public:
      ReplFutureMapImpl(
          ...
          IndexSpaceNode* domain, IndexSpaceNode* shard_domain, Runtime* rt,
          DistributedID did, Provenance* provenance,
          CollectiveMapping* collective_mapping);
      ReplFutureMapImpl(
          TaskContext* ctx, ShardManager* man, Runtime* rt,
          IndexSpaceNode* domain, IndexSpaceNode* shard_domain,
          DistributedID did, uint64_t index, std::optional<uint64_t> ctx_idx,
          Provenance* provenance, CollectiveMapping* collective_mapping);
    ...
    public:
      virtual Future get_future(
          const DomainPoint& point, bool internal, RtEvent* wait_on = NULL);
      virtual void get_all_futures(std::map<DomainPoint, FutureImpl*>& futures);
    public:
    ...
    public:
      OutputRegionImpl(
          ...
          const InstanceSet& instance_set, TaskContext* ctx, Runtime* rt,
    ...
    class GrantImpl : public Collectable,
                      public LegionHeapify<GrantImpl> {
    public:
    ...
    public:
      ImplicitShardManager(
          Runtime* rt, TaskID tid, MapperID mid, Processor::Kind k,
    ...
    public:
      static void handle_remote_rendezvous(
          Deserializer& derez, Runtime* runtime);
    public:
      Runtime* const runtime;
    ...
    public:
      ProcessorManager(
          Processor proc, Processor::Kind proc_kind, Runtime* rt,
          unsigned default_mappers, bool no_steal, bool replay);
...
#undef MEM_NAMES
    ...
    public:
      ...
      static void handle_notify_collected_instances(
          Deserializer& derez, Runtime* runtime);
    public:
      ...
      static void handle_create_memory_pool_request(
          Deserializer& derez, Runtime* runtime, AddressSpaceID source);
      static void handle_create_memory_pool_response(
          Deserializer& derez, Runtime* runtime);
    ...
    protected:
      ...
      typedef LegionMap<PhysicalManager*, GCPriority, MEMORY_INSTANCES_ALLOC>
          TreeInstances;
    ...
    public:
      void package_message(
          ...
          RtEvent flush_precondition, Runtime* runtime, Processor target,
          bool response);
      void process_message(
          const void* args, size_t arglen, Runtime* runtime,
    ...
    private:
      void send_message(
          bool complete, Runtime* runtime, Processor target, MessageKind kind,
          bool response, RtEvent send_precondition);
      void handle_messages(
          unsigned num_messages, Runtime* runtime,
          AddressSpaceID remote_address_space, const uint8_t* args,
          size_t arglen) const;
    ...
    public:
      MessageManager(
          AddressSpaceID remote, Runtime* rt, size_t max,
    ...
    public:
      ShutdownManager(
          ShutdownPhase phase, Runtime* rt, AddressSpaceID source,
    ...
    public:
      VariantImpl(
          Runtime* runtime, VariantID vid, TaskImpl* owner,
          const TaskVariantRegistrar& registrar, size_t return_type_size,
          bool has_return_type_size, const CodeDescriptor& realm_desc,
    ...
    public:
      static void handle_variant_broadcast(
          Runtime* runtime, Deserializer& derez);
      static bool check_padding(
          Runtime* runtime, const TaskLayoutConstraintSet& constraints);
    public:
      const VariantID vid;
    ...
    public:
      LayoutConstraints(
          LayoutConstraintID layout_id, FieldSpace handle, Runtime* runtime,
      ...
      LayoutConstraints(
          ...
          DistributedID did = 0, CollectiveMapping* collective_mapping = NULL);
      LayoutConstraints(
          LayoutConstraintID layout_id, Runtime* runtime,
          const LayoutConstraintSet& cons, FieldSpace handle, bool inter);
    ...
    public:
      static AddressSpaceID get_owner_space(
          LayoutConstraintID layout_id, Runtime* runtime);
    public:
    ...
    public:
      ...
      LogicalRegion project_point(
          Task* task, unsigned idx, Runtime* runtime,
          const Domain& launch_domain, const DomainPoint& point);
      void project_points(
          const RegionRequirement& req, unsigned idx, Runtime* runtime,
          const Domain& launch_domain,
      ...
      void find_inversions(
          unsigned op_kind, UniqueID uid, unsigned region_index,
    ...
    protected:
      ...
      // to an OpKind type
      void check_inversion(
          unsigned op_kind, UniqueID uid, unsigned idx,
          const std::vector<DomainPoint>& ordered_points,
          const Domain& launch_domain, bool allow_empty = false);
      void check_containment(
          unsigned op_kind, UniqueID uid, unsigned idx,
    ...
    public:
      ...
      static void add_to_projection_tree(
          LogicalRegion region, RegionTreeNode* root, RegionTreeForest* context,
    ...
    public:
      ShardingFunction(
          ShardingFunctor* functor, RegionTreeForest* forest,
      ...
      public:
        LegionConfiguration(void)
          : delay_start(0), legion_collective_radix(LEGION_COLLECTIVE_RADIX),
            ...
            report_leaks(false), separate_runtime_instances(false),
            record_registration(false), stealing_disabled(false),
            resilient_mode(false), unsafe_launch(false), unsafe_mapper(false),
            safe_mapper(false), safe_tracing(false),
...
#ifdef DEBUG_LEGION
            logging_region_tree_state(false), verbose_logging(false),
            logical_logging_only(false), physical_logging_only(false),
    ...
    public:
      ...
      IndexSpace get_index_subspace(
          Context ctx, IndexPartition p, const void* realm_color,
          TypeTag type_tag);
      IndexSpace get_index_subspace(
      ...
      void get_index_space_domain(
          Context ctx, IndexSpace handle, void* realm_is, TypeTag type_tag);
      void get_index_space_domain(
      ...
      void get_index_space_partition_colors(
          Context ctx, IndexSpace handle, std::set<Color>& colors);
      void get_index_space_partition_colors(
      ...
      void get_index_space_color_point(
          Context ctx, IndexSpace handle, void* realm_color, TypeTag type_tag);
      void get_index_space_color_point(
    ...
    public:
      ...
      LogicalRegion get_logical_subregion_by_color(
          Context ctx, LogicalPartition parent, const void* realm_color,
          TypeTag type_tag);
      LogicalRegion get_logical_subregion_by_color(
      ...
      void get_logical_region_color(
          Context ctx, LogicalRegion handle, void* realm_color,
          TypeTag type_tag);
      void get_logical_region_color(
    ...
    public:
      ...
      PhysicalRegion map_region(
          ...
          Provenance* provenance);
      void remap_region(
          Context ctx, const PhysicalRegion& region,
          Provenance* provenance = NULL);
    ...
    public:
      ...
      static MapperManager* wrap_mapper(
          Runtime* runtime, Mapper* mapper, MapperID map_id, Processor proc,
    ...
    public:
      ...
      void register_projection_functor(
          ...
          const char* warning_string = NULL, bool preregistered = false);
    ...
    public:
      ...
      void register_sharding_functor(
          ...
          bool silence_warnings = false, const char* warning_string = NULL,
    ...
    public:
      FutureImpl* find_or_create_future(
          ...
          RtEvent& registered, Operation* op = NULL, GenerationID op_gen = 0,
    ...
    public:
      ...
      LegionErrorType verify_requirement(
    ...
    protected:
      ...
      LegionMap<
          uint64_t, LegionDeque<ProcessorGroupInfo>, PROCESSOR_GROUP_ALLOC>
          processor_groups;
    protected:
    ...
    protected:
      ...
      LegionMap<
          DistributedID, DistributedCollectable*, RUNTIME_DIST_COLLECT_ALLOC>
          dist_collectables;
    ...
    protected:
      ...
      public:
        AllocationTracker(void)
          : total_allocations(0), total_bytes(0), diff_allocations(0),
            diff_bytes(0)
        { }
      public:
    ...
    protected:  // Control replication operations
      ...
      std::deque<ReplPendingPartitionOp*> available_repl_pending_partition_ops;
    ...
    //--------------------------------------------------------------------------
    template<typename T>
    inline T* Runtime::get_available(
        LocalLock& local_lock, std::deque<T*>& queue)
    //--------------------------------------------------------------------------
    {
      T* result = NULL;
      {
    ...
    //--------------------------------------------------------------------------
    {
      for (typename std::deque<T*>::const_iterator it = queue.begin();
           it != queue.end(); it++)
      {
#ifdef LEGION_TRACE_ALLOCATION
