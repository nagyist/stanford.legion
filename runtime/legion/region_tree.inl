  ...
  namespace Internal {
    ...
    //--------------------------------------------------------------------------
    {
      ...
      return set_realm_index_space(realm_space, ready, initializing,
          broadcast, runtime->address_space);
    }
    ...
    //--------------------------------------------------------------------------
    {
      ...
      IndexSpaceNode *result = runtime->create_node(new_handle, 
    ...
    //--------------------------------------------------------------------------
    {
      ...
      for (unsigned idx = 0; idx < handles.size(); idx++)
      {
        ...
        IndexSpaceNodeT<DIM,T> *space =
          static_cast<IndexSpaceNodeT<DIM,T>*>(runtime->get_node(handles[idx]));
...
#undef DIMFUNC
    ...
    //--------------------------------------------------------------------------
    {
      ...
      if (source)
      {
        ...
        return expr->issue_copy_internal(op,
